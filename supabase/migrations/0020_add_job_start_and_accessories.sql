-- Add start_date to jobs for timeline dragging
ALTER TABLE jobs 
ADD COLUMN IF NOT EXISTS start_date timestamp with time zone DEFAULT now();

-- Add accessories jsonb column to projects for the detailed spec table
ALTER TABLE projects
ADD COLUMN IF NOT EXISTS accessories jsonb DEFAULT '[]'::jsonb;

-- Update create_new_project function to include accessories
